...
const CALIBRATION_MAGNITUDE_CANDIDATES = [3.5, 4.5, 5.5, 6.5, 7.5];
...
function buildDepthCandidates(pointCount, stage, coarseBestDepthKm) {
  ...
  const maxDepth = pointCount <= SOME_POINTS_MAX_FOR_DEPTH_CAP ? SOME_POINTS_MAX_DEPTH_KM : MANY_POINTS_MAX_DEPTH_KM;
  if (stage === "coarse") {
